...
#include <locale.h>
/*
I. Se cuenta con una lista con los resultados de 20 matrículas estudiantiles en un concurso internacional de matemáticas. 
...
int main() {
	...
	int matricula,matricula2, naci, uni, cal1, cal2, cal3, cal4,mx,c,part,wady,prom=0,prom1=0;
	c=0;
	mx=0;
	wady=0;
	...
	printf("El número de participantes que participaron fueron: %d \n",c); //Se imprime el número de participantes
	printf("El número de participantes de la UADY fue: %d \n", wady); //Se imprime el número de participantes Uady
	printf("El número de participantes mexicanos fue: %d \n",mx); //Se imprime el número de participantes mexicanos
	printf("El participante que tuvo mayor calificación fue %d",matricula2); //Se imprimela matrícula del participantes mayor
