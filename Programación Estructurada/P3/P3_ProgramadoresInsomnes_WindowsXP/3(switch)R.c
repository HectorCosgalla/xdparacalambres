...
/* Q/A: El codigo se ejecuta correctamente. Se ejecutaron 3 casos:
        1) 4 hits 2) 2 hits/2 outs 3) 4 bolas por base.
        En el caso 1) se obtuvo "El jugador bateo 4 hit(s) 0 out(s) y 0 base por bola." y "El porcentaje de bateo del jugador fue de 100.00"
        En el caso 2) se obtuvo "El jugador bateo 2 hit(s) 2 out(s) y 0 base por bola." y "El porcentaje de bateo del jugador fue de 50.00"
        En el caso 3) se obtuvo "El jugador bateo 0 hit(s) 0 out(s) y 4 base por bola." y "El porcentaje de bateo del jugador fue de 00.00"

       Por lo tanto, el codigo evaluado cumple con la funcion que se pide correctamente y sin problemas. EVALUADO POR HERVE ORDAZ OSORIO del equipo WindowsXP. */
